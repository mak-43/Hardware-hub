...
const Purchase = () => {
    ...
    const handleSubmit = async e => {
        ...
        await axios.post("https://desolate-bayou-39842.herokuapp.com/order", inputData).then((res) => {
            console.log(res)
    ...
    const { isLoading, error, data: product } = useQuery('tools', () => fetch(`https://desolate-bayou-39842.herokuapp.com/tools/${id}`).then(res => res.json()))
    if (isLoading) {
        return <Loading />
    }
