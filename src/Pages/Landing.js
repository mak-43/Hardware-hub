            ...
            <div class="carousel w-full">
                ...
                <div id="item2" class="carousel-item w-full relative">
                    ...
                    <div class="absolute  transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <h1 className=' flex justify-center  bottom-0  md:text-2xl lg:text-3xl font-bold text-yellow-600'>All products are intake </h1>
                    </div>
                </div>
                <div id="item3" class="carousel-item w-full relative">
                    ...
                    <div class="absolute  transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <h1 className=' flex justify-center  bottom-0  md:text-2xl lg:text-3xl font-bold text-white'>Latest Pretest products</h1>
                    </div>
                </div>
